################################################################
# 2020.09.08 articleparser.py: 기존 articleparser.py 파일입니다.
# subcategory (sid2)를 고려하지 않습니다.
################################################################
#!/usr/bin/env python
# -*- coding: utf-8, euc-kr -*-
...
class ArticleCrawler(object):
    def __init__(self):
        #  '연예': 106, '스포츠': 107 는 현재 되지 않아 리스트에서 제외
        self.categories = {'정치': 100, '경제': 101, '사회': 102, '생활문화': 103, '세계': 104, 'IT과학': 105, '오피니언': 110}
        self.subcategories = {}
        self.subcategories['경제'] = {'증권': 258, '금융': 259, '부동산': 260, '산업/재계': 261, '글로벌경제': 262, '경제일반': 263, '생활경제': 310, '증기벤처': 771}
    ...
    def crawling(self, category_name):
        ...
        print("day_urls: {}".format(day_urls[:3]))
...
if __name__ == "__main__":
    ...
    # Crawler.set_category(*tuple(re.split(' ', TARGET)))
