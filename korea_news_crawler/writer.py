...
class Writer(object):
    def __init__(self, category_name, date, subcategory_name=''):
    ...
    def initialize_file(self):
        if self.user_operating_system == "Windows":
            self.file = open('Article_' + self.category_name + self.subcategory_name + '_' + str(self.save_start_year) + self.save_start_month
        ...
        # Other OS uses utf-8
            ...
            self.file = open('Article_' + self.category_name + self.subcategory_name + '_' + str(self.save_start_year) + self.save_start_month
                             ...
                             newline='')
        print("creating the file: {}".format(self.file))
